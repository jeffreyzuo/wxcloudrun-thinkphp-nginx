...
namespace app\extend\traits;

use think\Exception;
use app\extend\support\Arr;
use app\extend\support\Str;
trait HasAttributes
{
    /**
     * @var array
    ...
    public function __call($method, $args)
    {
        ...
        throw new Exception(sprintf('Method "%s" does not exists.', $method),90004);
    }
    ...
    protected function checkRequiredAttributes()
    {
        foreach ($this->getRequired() as $attribute) {
            if (is_null($this->get($attribute))) {
                throw new Exception(sprintf('"%s" cannot be empty.', $attribute),90003);
            }
        }
    }
